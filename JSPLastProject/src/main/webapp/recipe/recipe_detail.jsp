              ...
              <table class="table">
               <tr>
                <td colspan="3" class="text-center">
                  <img src="${vo.poster }" style="width: 100%; height: 800px">
                </td>
               </tr>
               ...
               <tr>
                <td class="text-cneter"><img src="../recipe/icon/a1.png"></td>
                <td class="text-cneter"><img src="../recipe/icon/a1.png"></td>
                <td class="text-cneter"><img src="../recipe/icon/a1.png"></td>
               </tr>
               
               <tr>
                <td class="text-cneter">${vo.info1 }</td>
                <td class="text-cneter">${vo.info2 }</td>
                <td class="text-cneter">${vo.info3 }</td>
               </tr> 
              </table>
              <table class="table">
