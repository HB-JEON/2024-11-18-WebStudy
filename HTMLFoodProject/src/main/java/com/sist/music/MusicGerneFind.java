...
@WebServlet("/MusicGerneFind")
public class MusicGerneFind extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<a href=MusicGerneFind?cno=1 class=\"btn btn-sm btn-danger\">TOP 50</a>");
		out.println("<a href=MusicGerneFind?cno=2 class=\"btn btn-sm btn-success\">가요</a>");
		out.println("<a href=MusicGerneFind?cno=3 class=\"btn btn-sm btn-info\">POP</a>");
		out.println("<a href=MusicGerneFind?cno=4 class=\"btn btn-sm btn-primary\">OST</a>");
		out.println("<a href=MusicGerneFind?cno=5 class=\"btn btn-sm btn-warning\">트롯</a>");
		...
		if(startPage>1)
		{
			out.println("<li><a href=\"MusicGerneFind?cno="+cno+"&page="+(startPage-1)+"\">&lt;</a></li>");
		}
		for(int i=startPage;i<=endPage;i++)
		{
			if(i==curpage)
				...
				out.println("<li><a href=\"MusicGerneFind?cno="+cno+"&page="+i+"\">"+i+"</a></li>");
		}
		if(endPage<totalpage)
		{
