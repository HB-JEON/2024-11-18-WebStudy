...
public class MainServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String html="<nav class=\"navbar navbar-inverse\">"
				...
				+ "          <li><a href=\"MainServlet?mode=3\">맛집 검색 1</a></li>"
				+ "          <li><a href=\"MainServlet?mode=4\">맛집 검색 2</a></li>"
				+ "        </ul>"
				+ "      </li>"
				+ "      <li class=\"dropdown\">"
				...
				+ "        <span class=\"caret\"></span></a>"
				+ "        <ul class=\"dropdown-menu\">"
				+ "          <li><a href=\"MainServlet?mode=7\">음악 검색 1</a></li>"
				+ "          <li><a href=\"MainServlet?mode=8\">음악 검색 2</a></li>"
				+ "        </ul>"
				+ "      </li>"
				+ "      <li><a href=\"#\">게시판</a></li>"
				+ "      <li><a href=\"#\">기타</a></li>"
		...
		/*
		   <div class="row text-right">
		                  - *** 공백 사용 불가능
		   <div class=row class=text-right> => 클래스로 인식하여 사용 불가능
		 */
		...
		/*
		    ...
		    Session
		     ...
		     => 주요 메소드 => 같은 브라우저에서는 사용자당 1개만 세션 사용
                저장 => setAttribute()
                읽기 => getAttribute()
                삭제 => removeAttribute()
                전체 삭제 => invalidate() => 로그아웃
             => 값이 없는 경우 => session 로그인 안된 상태 => null
             => 회원 가입 => 로그인
		 */
