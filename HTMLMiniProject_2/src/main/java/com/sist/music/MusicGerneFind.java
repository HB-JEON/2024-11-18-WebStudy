...
public class MusicGerneFind extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<a href=MainServlet?mode=3&cno=1 class=\"btn btn-sm btn-danger\">TOP 50</a>");
		...
		out.println("<a href=MainServlet?mode=3&cno=7 class=\"btn btn-sm btn-link\">CLASSIC</a>");
		out.println("</div>");
