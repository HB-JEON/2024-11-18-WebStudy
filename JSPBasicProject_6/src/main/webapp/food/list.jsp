...
<body>
  <div class="container">
   ...
   <div class="row">
     <h3>최근 방문 맛집</h3>
     <a href="cookie_all_delete_.jsp" class="btn btn-sm btn-primary">전체 삭제</a>
     <hr>
     <%
			    ...
			    <div class="thumbnail">
			     <%-- 상세보기(한개) => 중복없이 적용된 데이터(PRIMARY KEY) --%>
			      <a href="detail.jsp?fno=<%= vo.getFno() %>">
			        ...
			        <div class="caption">
			          <p class="text-right"><a href="cookie_delete.jsp?fno=<%= vo.getFno() %>" class="btn btn-xs btn-danger">삭제</a></p>
			        </div>
			      </a>
			    </div>
			   </div>
